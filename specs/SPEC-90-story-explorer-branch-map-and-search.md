...
**Status**: draft
**Depends on**: SPEC-87 (backend foundation; archived at `archive/specs/SPEC-87-story-explorer-backend-foundation.md`), SPEC-88 (frontend foundation; archived at `archive/specs/SPEC-88-story-explorer-frontend-foundation.md`), SPEC-89 (state x-ray; archived at `archive/specs/SPEC-89-story-explorer-state-xray-layer.md`)
