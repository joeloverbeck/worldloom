...
- `SPEC-17` Track C1 (notes-paragraph deprecation) — completed and archived at `archive/tickets/SPEC17AUDTRARET-001.md`.
...
- SPEC-16 is implemented: all four MCP retrieval-surface sub-tracks landed with package-local proof, and cross-track docs are updated.
