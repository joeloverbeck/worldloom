...
Current state as of 2026-05-09: SPEC-19, SPEC-20, and SPEC-21 are completed and archived. SPEC-22 remains the active machine-facing / cross-skill foundation for engine ops, validators, canonical vocabularies, indexer/MCP retrieval, sibling-skill alignment, migration, and deterministic runtime/authoring proof. The remaining post-foundation work is the Tier 4 pilot.
