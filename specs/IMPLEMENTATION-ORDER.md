...
SPEC-121 (acceptance flow)   LAST — exercises archived SPEC-117 (workbench) + archived SPEC-118 (exclusion/3-5 beats)
```

Only **SPEC-121** has hard prerequisites (archived SPEC-117 and archived SPEC-118). SPEC-117, SPEC-118, SPEC-119, and SPEC-120 are completed and archived.
