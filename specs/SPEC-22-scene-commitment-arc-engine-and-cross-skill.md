...
| `.claude/skills/story-fact-promotion-to-canon/SKILL.md` | 4 | completed by `archive/tickets/SPEC22SCECOM-012.md` — add `source_kind: arc_effect_promotion`; extend pre-flight, Phase 1/2/4/10, and SP-NNNN package shape |
| `.claude/skills/story-fact-promotion-to-canon/templates/proposal-package.yaml` | 4 | completed by `archive/tickets/SPEC22SCECOM-012.md` — add arc-effect source fields and provenance structure |
| `.claude/skills/story-fact-promotion-to-canon/templates/story-promotion-ledger.md` | 4 | completed by `archive/tickets/SPEC22SCECOM-012.md` — add arc-effect provenance and supersession attribution fields |
