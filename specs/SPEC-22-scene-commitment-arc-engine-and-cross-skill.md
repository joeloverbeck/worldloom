...
| `.claude/skills/branching-story-page-cycle/references/record-schemas.md` | 4 | completed by `archive/tickets/SPEC22SCECOM-013.md` — extend PG.state_snapshot with applied_effect_variant + narrative_point_classification + arc_trace_id + arc_trace_emitted |
