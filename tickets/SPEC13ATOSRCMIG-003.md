...
10. Monolithic-filename absence: `grep -rEc "CANON_LEDGER\.md|INVARIANTS\.md|MYSTERY_RESERVE\.md|OPEN_QUESTIONS\.md|EVERYDAY_LIFE\.md|INSTITUTIONS\.md|MAGIC_OR_TECH_SYSTEMS\.md|GEOGRAPHY\.md|ECONOMY_AND_RESOURCES\.md|PEOPLES_AND_SPECIES\.md|TIMELINE\.md" specs/ docs/ CLAUDE.md` returns 0 for all matches (skill `SKILL.md` exempted per reassess I1).
...
4. `grep -rEc "CANON_LEDGER\.md|INVARIANTS\.md|MYSTERY_RESERVE\.md|OPEN_QUESTIONS\.md|EVERYDAY_LIFE\.md|INSTITUTIONS\.md|MAGIC_OR_TECH_SYSTEMS\.md|GEOGRAPHY\.md|ECONOMY_AND_RESOURCES\.md|PEOPLES_AND_SPECIES\.md|TIMELINE\.md" specs/ docs/ CLAUDE.md` — must return 0 (skill `SKILL.md` intentionally exempted per reassess I1).
