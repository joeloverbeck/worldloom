...
**Deps**: archive/tickets/PROSESPLIT2-001.md (canonical-source files in place), archive/tickets/PROSESPLIT2-002.md (skill-side references migrated), PROSESPLIT2-003 (FOUNDATIONS / IMPL-ORDER / brainstorm refs migrated). All three must land first or this ticket leaves dangling references.
