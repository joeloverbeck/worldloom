...
**Deps**: archive/tickets/SPEC114MANSTOSTU-002.md, archive/tickets/SPEC114MANSTOSTU-003.md, archive/tickets/SPEC114MANSTOSTU-004.md
...
3. **Cross-artifact shared boundary under audit**: the README delete-outcomes section must describe the outcomes produced by archive/tickets/SPEC114MANSTOSTU-002.md (backend), reflected in archive/tickets/SPEC114MANSTOSTU-003.md (records UX) and archive/tickets/SPEC114MANSTOSTU-004.md (beat-template parity) coherently — hence the dependency on all three. The ID-ALLOCATION note must match the `repair-log.yaml` path/shape established in archive/tickets/SPEC114MANSTOSTU-002.md §1.
