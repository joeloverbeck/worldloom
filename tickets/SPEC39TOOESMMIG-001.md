...
**Deps**: `tickets/SPEC39TOOESMMIG-004.md`, `tickets/SPEC39TOOESMMIG-002.md` (downstream TypeScript consumers must be ESM before they can compile against an ESM patch-engine package)
