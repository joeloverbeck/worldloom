...
2. **All STCHAR validators PASS on migrated red-bunny fixtures** -> `npm test --prefix tools/validators` runs the full validator suite (including the new 3 from `archive/tickets/SPEC74STCHARDISBOU-008.md` / -009 / `archive/tickets/SPEC74STCHARDISBOU-011.md` + extensions from -007 + -010) and asserts 0 STCHAR-related failures on red-bunny.
