...
**Deps**: SPEC64WORSYSCOM-001, SPEC64WORSYSCOM-002
...
3. Cross-artifact boundary under audit: the compatibility subset is a name set spanning four registry entries; it depends on SPEC64WORSYSCOM-001 and -002 having registered `artifact_maturity` and `index_disk_consistency` respectively. The shared contract is the validator-name set the selection references.
