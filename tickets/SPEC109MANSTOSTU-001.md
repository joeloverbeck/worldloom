...
Declare the exported `CurrentContext` interface verbatim from SPEC-109 §2 item 1. Include the comment annotations from the spec (ID-prefix hints, `last_reviewed_after_segment` SPEC-108 precondition note).
