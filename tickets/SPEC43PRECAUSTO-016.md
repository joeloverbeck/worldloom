...
Document the new SAU section the compatibility audit mode emits:
...
Insert near the existing Phase 2i rule at line 280:
...
Phase 2i mechanism-health rules at line 280 ("absence of CLK / STSEC / STQ records is never itself a finding") remain unchanged. SPEC-43's compatibility-drift validator handles absence as `info`-level "compatible optional absence" (NOT a Phase 2i finding).
