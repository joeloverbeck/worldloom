...
**Deps**: archive/tickets/SPEC112MANSTOSTU-004.md, 005, 006, 007
...
3. Cross-artifact boundary under audit: this test asserts the post-implementation state of four surfaces modified by `archive/tickets/SPEC112MANSTOSTU-004.md` (EditCurrentContext), -005 (RecordForm), -006 (CurrentStatePanel), and -007 (MomentComposer), plus the presence of the `archive/tickets/SPEC112MANSTOSTU-003.md` `RecordPicker`. Its Deps are those four mount tickets (the leaf set — each transitively reaches `archive/tickets/SPEC112MANSTOSTU-003.md` → `archive/tickets/SPEC112MANSTOSTU-001.md` / `archive/tickets/SPEC112MANSTOSTU-002.md`).
