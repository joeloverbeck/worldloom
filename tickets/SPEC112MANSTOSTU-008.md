...
3. Cross-artifact boundary under audit: this test asserts the post-implementation state of four surfaces modified by SPEC112MANSTOSTU-004 (EditCurrentContext), -005 (RecordForm), -006 (CurrentStatePanel), and -007 (MomentComposer), plus the presence of the -003 `RecordPicker`. Its Deps are those four mount tickets (the leaf set — each transitively reaches 003 → `archive/tickets/SPEC112MANSTOSTU-001.md` / `archive/tickets/SPEC112MANSTOSTU-002.md`).
