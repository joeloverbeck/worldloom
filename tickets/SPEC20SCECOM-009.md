...
**Deps**: `archive/tickets/SPEC20SCECOM-001.md`, `archive/tickets/SPEC20SCECOM-002.md`, `archive/tickets/SPEC20SCECOM-003.md`, `archive/tickets/SPEC20SCECOM-004.md`, `archive/tickets/SPEC20SCECOM-005.md`, `archive/tickets/SPEC20SCECOM-006.md`, SPEC20SCECOM-008, `archive/tickets/SPEC20SCECOM-012.md`, `archive/tickets/SPEC20SCECOM-013.md`, `tickets/SPEC20SCECOM-014.md` (all phase reference files and the Phase 8 / Phase 7.5 CHC v2 vocabulary cleanups must land before SKILL.md cites them coherently); `specs/SPEC-22-scene-commitment-arc-engine-and-cross-skill.md` (SPEC-22 §Track 2 implements 4 of the 5 new validators; the 5th — `arc_envelope_conformance` — is documented in SPEC-22's §Risks as a cross-spec gap to close at the post-SPEC-21 SPEC-22 reassessment)
