...
**Deps**: `archive/tickets/SPEC21SCECOM-001.md`, `archive/tickets/SPEC21SCECOM-002.md`, `archive/tickets/SPEC21SCECOM-003.md`, SPEC21SCECOM-004, SPEC21SCECOM-005, SPEC21SCECOM-006 (all upstream Phase rewrites + new template + governance update — SKILL.md must reflect ALL Phase rewrites; manifest must reflect arc semantics from Phase 4-5)
