...
- Persistent cooldown trace records (rejected — `archive/specs/IMPLEMENTATION-ORDER-2026-05-25-2.md:27` §Out-of-Scope SSEL rejection; `reports/slt-chc-overhaul-third-iteration.md` §7 Alternative C rejection).
