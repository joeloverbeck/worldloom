...
2. The op design + the "do not model on append-character-record.ts" correction are specified in `archive/specs/SPEC-56-stchar-machine-foundation.md` §Phase 4 (reassessed this session — finding I1 corrected the original world-canon-pattern mismodel).
