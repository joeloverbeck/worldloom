...
- Shared contract updates (`story-record-schemas.md` §4.6 + §4.2a) — landed in `archive/tickets/SPEC72PLAHASADV-002.md` (this ticket depends on the archived ticket so the SKILL's references to the contract align with the contract's updated state).
