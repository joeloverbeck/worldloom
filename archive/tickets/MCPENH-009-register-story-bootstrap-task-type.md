...
- The active worktree still contains pre-existing same-family untracked scope: `.claude/skills/branching-story-bootstrap/` is active-ticket owned where edited for this ticket, and this archived ticket records the MCPENH-009 handoff; `tickets/MCPENH-010-add-story-id-class-to-allocator.md` remains sibling scope; the `brainstorming/branching-story-bootstrap.md` -> `archive/brainstorming/branching-story-bootstrap.md` rename remains pre-existing unrelated dirt.
