...
- Repo-level quick-reference docs contained pre-landing wording for the CLI in `docs/WORKFLOWS.md`; post-ticket review routed that bounded documentation cleanup to `archive/tickets/SPEC07DOCUPD-001.md` rather than widening this implementation ticket after proof.
