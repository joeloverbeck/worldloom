...
2. Spec: `archive/specs/SPEC-106-manual-story-studio-prompt-leakage-hard-tier.md` §2.3 + §3 *Disabled-button is the primary guard; early return is defense-in-depth* + §4 *Files to touch* — the ticket's line citations matched the codebase at intake.
