...
2. Documentation references in `tools/world-index/README.md`, `docs/MACHINE-FACING-LAYER.md`, and `tools/world-mcp/README.md` remain intentionally out of scope under active `tickets/SPEC29LEGTOOVOC-005.md`.
