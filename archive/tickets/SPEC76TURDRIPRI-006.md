...
**Deps**: archive/tickets/SPEC76TURDRIPRI-002.md, archive/tickets/SPEC76TURDRIPRI-005.md
...
2. Parse the page-plan §7a active-pressure disposition table via the shared parser (introduced in archive/tickets/SPEC76TURDRIPRI-005.md).
