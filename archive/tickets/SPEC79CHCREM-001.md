...
- SPEC79CHCREM-010 owns remaining non-behavioral fixture-key drops, including `tools/validators/tests/integration/spec34-integration.test.ts`, `tools/validators/tests/integration/spec49-stplan-stemo-hardening.test.ts`, `tools/validators/tests/structural/stchar-structural-validators.test.ts`, and `tools/validators/tests/rules/rule_chc_grounded_in_artifact_accessible.test.ts`.
