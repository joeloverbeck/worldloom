...
6. **Final docs boundary**: `docs/MACHINE-FACING-LAYER.md`, `tools/world-mcp/README.md`, and `tools/world-index/README.md` still advertise the retired vocabulary classes after this code ticket lands. That is intentional same-family residual work owned by active `tickets/SPEC29LEGTOOVOC-005.md`, whose `Deps` include this ticket.
...
7. Same-seam docs/README inspection found retired vocabulary prose in `docs/MACHINE-FACING-LAYER.md`, `tools/world-mcp/README.md`, and `tools/world-index/README.md`; those hits are explicitly owned by active follow-up `tickets/SPEC29LEGTOOVOC-005.md`.
...
2. `docs/MACHINE-FACING-LAYER.md`, `tools/world-mcp/README.md`, and `tools/world-index/README.md` remain stale after this ticket by design. They are excluded from this implementation ticket and owned by `tickets/SPEC29LEGTOOVOC-005.md`.
