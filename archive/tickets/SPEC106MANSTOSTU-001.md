...
2. Spec: `archive/specs/SPEC-106-manual-story-studio-prompt-leakage-hard-tier.md` §2.1 + §4 + §3 *Beat-template scan helper mirrors main-lint discipline* — line citations match the codebase exactly.
