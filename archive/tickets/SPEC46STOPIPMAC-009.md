...
2. `archive/specs/SPEC-46-story-pipeline-machine-facing-foundation-fixes.md` §Phase C table specifies the single STSTAT edge (`status_entity`). The §Extractor implementation pattern paragraph names `edgesForStoryStatus` as one of the seven per-class helpers.
