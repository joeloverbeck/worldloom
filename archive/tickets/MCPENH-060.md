...
- Deriving `STORY_SOURCE_DIRECTORIES` from the parser-side story directory authority (the recurrence-prevention refactor) — completed and archived as `archive/tickets/MCPENH-061.md`.
