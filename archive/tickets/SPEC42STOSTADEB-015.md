...
2. Spec verified at `specs/SPEC-42-story-state-debt-secret-clock-records.md` §Verification. The live repo has executable machine surfaces for schema, validator, MCP, and patch-plan behavior, but the story-pipeline skills are prose workflows without an executable dry-run runner.
