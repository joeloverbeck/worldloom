...
2. The node type, hybrid-parse, and 4 edges are specified in `archive/specs/SPEC-56-stchar-machine-foundation.md` §Phase 5 (reassessed this session). The hybrid parser is modeled on the existing `character_record` parser.
