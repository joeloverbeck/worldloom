...
2. Spec: `archive/specs/SPEC-106-manual-story-studio-prompt-leakage-hard-tier.md` §2.4 + §4 *Files to touch* (`src/write/prompts.ts`, `src/server/routes/prompts.ts:8/59-62/324/331-332`, `src/prompt/types.ts` legacy mark) + §2 Out-of-Scope retirement clause for AC #9.
