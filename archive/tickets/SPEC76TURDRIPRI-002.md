...
Carve-out: §7a is omitted when SE-1 is `story_start` (driver-less) per archive/tickets/SPEC76TURDRIPRI-009.md (bootstrap skill).
...
- Active skill SKILL.md references to "8 shared hard gates" remain out of scope and are owned by SPEC76TURDRIPRI-008 / archive/tickets/SPEC76TURDRIPRI-009.md turn-cycle and bootstrap skill updates.
