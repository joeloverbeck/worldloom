...
The following items from the second-iteration audit report (`archive/reports/new-story-structures-proposal-second-iteration.md`) are explicitly out of scope for SPEC-49.
