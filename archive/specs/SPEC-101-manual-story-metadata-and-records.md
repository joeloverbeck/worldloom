...
**Depends on:** **SPEC-100** (package skeleton, write sandbox, `enumerate.ts` exclusion, web frontend shell). SPEC-100 landed 2026-05-30 (archived at `archive/specs/SPEC-100-manual-story-studio-package-boundary.md`); SPEC-101 is the next ticketization per `specs/IMPLEMENTATION-ORDER.md`.
