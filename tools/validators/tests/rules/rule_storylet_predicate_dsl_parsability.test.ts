...
function validReferenceRecords(): IndexedRecord[] {
  return [
    ...
    record("story_consequence_record", "marla:CNSQ-0001", "stories/marla/_source/consequences/CNSQ-0001.yaml", { id: "CNSQ-0001" }),
    record("thread_record", "marla:THR-0001", "stories/marla/_source/threads/THR-0001.yaml", { id: "THR-0001" }),
    record("story_relationship_record", "marla:SREL-0001", "stories/marla/_source/relationships/SREL-0001.yaml", { id: "SREL-0001" }),
