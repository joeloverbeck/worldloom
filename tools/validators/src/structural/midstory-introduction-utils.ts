...
export class MidstoryIntroductionTagError extends Error { constructor(message: string) { super(message); this.name = new.target.name; } } const TagError = MidstoryIntroductionTagError;
