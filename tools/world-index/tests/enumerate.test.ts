...
test("story-bundle paths are recognized as indexable closed inventory", () => {
  ...
  try {
    for (const relativeFilePath of [
      ...
      "stories/foo/_source/clocks/CLK-0001.yaml",
      "stories/foo/_source/secrets/STSEC-0001.yaml",
      "stories/foo/_source/story-questions/STQ-0001.yaml",
      "stories/foo/_source/plans/STPLAN-0001.yaml",
      "stories/foo/_source/emotions/STEMO-0001.yaml",
