...
describe('NotFoundPage', () => {
  it('links page misses back to the story root when story params are available', () => {
    render(
      <MemoryRouter>
        <NotFoundPage worldSlug="fixture world" storySlug="red bunny" resourceLabel="page" />
      </MemoryRouter>,
    );
    ...
    expect(screen.getByRole('link', { name: 'Back to story root' })).toHaveAttribute(
      'href',
      '/worlds/fixture%20world/stories/red%20bunny/entry',
    );
  });
