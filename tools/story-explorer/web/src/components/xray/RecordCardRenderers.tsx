...
const FIELD_ALIASES: Record<string, string[]> = {
  ...
  appraisal: ['appraisal_basis', 'appraisal', 'description', 'reason'],
  ...
  compatibleTurnDrivers: ['grounding.compatible_turn_drivers', 'compatible_turn_drivers'],
  currentLeaf: ['current_leaf', 'leaf_page_id'],
  currentSceneRole: ['current_scene_role', 'scene_role'],
  currentStep: ['current_step', 'next_steps'],
  currentValue: ['value', 'current_value', 'current_tick'],
  ...
  groundedIn: ['grounded_in.records', 'grounded_in'],
  holder: ['holder'],
  holders: ['holders'],
  intensity: ['intensity'],
  ...
  orientation: ['orientation.toward_records', 'orientation', 'target'],
  ...
  targets: ['targets'],
  threshold: ['max', 'threshold', 'max_tick'],
