...
describe('RecordCardRenderers', () => {
  it.each([
    ...
    ['CHC', [{ name: 'surface_label', value: 'Open the gate' }, { name: 'player_visible_intent', value: 'Enter quietly' }, { name: 'likely_state_pressure', value: 'alarm' }, { name: 'grounded_in.records', value: 'SF-1, SF-2' }], { links: [link('PG')] }, ['CHC-1', '"Open the gate"', 'Enter quietly', 'pressure alarm', 'grounded-in SF-1, SF-2', 'child-outcomes 1']],
    ...
    ['CLK', [{ name: 'title', value: 'Alarm clock' }, { name: 'value', value: '2' }, { name: 'max', value: '4' }, { name: 'driver', value: 'noise' }, { name: 'last_tick_event', value: 'SE-1' }], { status: 'ticking' }, ['CLK-1', '"Alarm clock"', '2/4', 'driver noise', 'ticking', 'last-tick SE-1']],
    ...
    ['SLT', [{ name: 'move_family', value: 'infiltration' }, { name: 'scope.visibility', value: 'author' }, { name: 'scope.branch_id', value: 'BR-1' }, { name: 'saliency.urgency', value: 'high' }, { name: 'grounding.compatible_turn_drivers', value: 'choice' }, { name: 'precondition_count', value: '2' }, { name: 'effect_count', value: '3' }], {}, ['SLT-1', 'infiltration', 'scope author', 'branch BR-1', 'saliency high', 'drivers choice', 'preconds 2', 'effects 3']],
