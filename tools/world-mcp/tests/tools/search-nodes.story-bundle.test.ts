  ...
  try {
    ...
    assert.deepEqual(
      ...
      [
        ...
        ["opening-bells:STEMO-0", "story_emotion_record", STORY_FIXTURE_SLUG],
        ["opening-bells:STEMO-1", "story_emotion_record", STORY_FIXTURE_SLUG],
        ...
        ["opening-bells:STPLAN-1", "story_plan_record", STORY_FIXTURE_SLUG],
