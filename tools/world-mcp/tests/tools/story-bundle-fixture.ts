    ...
    nodes: [
      ...
      },
      {
        ...
        body: [
          ...
          "  canon_revision: CH-1",
          "  active_records:",
          "    STENT: [STENT-2, STENT-3]",
          "    STCHAR: [STCHAR-1]",
          "    STINT: [STINT-1]",
          "    SF: [SF-1]",
          "    BEL: [BEL-1, BEL-2, BEL-3]",
          "    OBL: [OBL-1, OBL-2, OBL-3, OBL-4, OBL-5]",
          "    CNSQ: []",
          "    THR: [THR-1]",
          "    SREL: [SREL-1, SREL-2]",
          "    STLOC: [STLOC-1]",
          ...
          "  - CHC-1",
          "validation_trace:",
          "  input_legality: 'PASS: story start input is lawful.'",
          "  parent_snapshot_compatibility: 'PASS: bootstrap page has no parent.'",
          "  mystery_invariant_firewall: 'PASS: mystery remains apparent.'",
          "  branch_isolation: 'PASS: bootstrap branch is isolated.'",
          "  append_only_delta: 'PASS: bootstrap records were created append-only.'",
          "  consequence_or_terminal: 'PASS: continuation remains open.'",
          "  plan_grounding: 'PASS: plan is grounded in seed records.'",
          "  canon_promotion_hold: 'PASS: no canon-candidate claim is asserted.'",
          "  turn_driver_lawfulness: 'PASS: story start driver is lawful.'",
          ""
        ].join("\n")
      },
      {
