...
export function buildStoryBundleWorld(root: string): void {
  seedWorld(root, {
    ...
    nodes: [
      ...
      {
        node_id: storyNodeId(STORY_FIXTURE_SLUG, "ARCTRACE-0001"),
        world_slug: STORY_FIXTURE_WORLD,
        story_slug: STORY_FIXTURE_SLUG,
        file_path: storyPath(STORY_FIXTURE_SLUG, "arc-traces", "ARCTRACE-0001.yaml"),
        node_type: "arc_trace_node",
        body: [
          "id: ARCTRACE-0001",
          "story_id: STORY-001",
          "created_at_page: PG-0001",
          "arc_realized: SLT-0021",
          "effect_variant_applied: trust-offered",
          "realized_beats:",
          "  - beat_id: beat-1",
          "    function: offer",
          "    evidence_span:",
          ...
          "      end: 25",
          "observed_claims:",
          "  - claim: Marla can leave the loft safely.",
          "    source: narrator",
