...
const RECORD_TYPE_TO_NODE_TYPE: Record<ListRecordType, NodeType> = {
  ...
  story_status_record: "story_status_record",
  story_character_authority_record: "story_character_authority_record",
  story_plan_record: "story_plan_record",
  story_emotion_record: "story_emotion_record",
  ...
  pressure_clock_record: "pressure_clock_record",
  story_secret_record: "story_secret_record",
  story_question_record: "story_question_record",
