...
| `tickets/BSBOOT-004.md` | STORY_KERNEL vs INDEX shape-label enum disagreement (use full enum everywhere) | report #18 |
| `tickets/BSBOOT-005.md` | `canon_revision: ""` should be `null` in BR + PG examples | report #17 |
...
| `tickets/BSBOOT-011.md` | Storylet pool sizing not scale-aware (intended_scale unused by Phase 6) | report #8 |
...
| Ticket | Finding | Path |
|---|---|---|
| `tickets/BSBOOT-013.md` | Strengthen gate 11 with simulated post-choice continuation validation | report #13 |
| `tickets/BSBOOT-014.md` | Phase 7.5 visible-affordance extraction (parse rendered prose, feed to Phase 8) | report #15 |
