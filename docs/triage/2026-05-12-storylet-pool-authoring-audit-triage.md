...
- **Predicate-DSL stop-args drift is split to [STPOOL-014](../../tickets/STPOOL-014-align-predicate-dsl-stop-args-with-validator.md).** STPOOL-013 reassessment found unrelated stop-predicate args rows in `templates/predicate-dsl.md` that still need alignment with the live validator and bootstrap landmine table.
