...
- `archive/tickets/PPLAN-001-cast-material-reality-projection.md` — completed; adds `body.Material Reality` to CHAR-dossier projection in bootstrap + page-cycle pre-flight + canonical template + both phase-7 references. Blocks archived PPLAN-003 and active PPLAN-004.
