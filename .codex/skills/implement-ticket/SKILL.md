...
- for staged tool/schema tickets, apply the focused parser, persistence, hash, generated-operation, and response-shape checks in `references/package-tooling.md`; keep those specialized package details out of this top-level workflow
