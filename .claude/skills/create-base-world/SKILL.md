...
1. One-paragraph world kernel · 2. invariant table (id / category / one-line statement) · 3. species / peoples summary (cluster / population scale / distinguishing embodiment) · 4. geography-pressure summary · 5. institutional summary · 6. historical pressure summary · 7. pressure systems · 8. mystery reserve entries (id / status / one-line title) · 9. CF-0001 statement and `domains_affected` · 10. genesis-bundle counts (`#CF: 1`, `#CH: 1`, `#INV: ≥5`, `#M: ≥3`, `#OQ`, `#ENT`, `#SEC: 7`) · 11. unmapped-premise items (if any).
