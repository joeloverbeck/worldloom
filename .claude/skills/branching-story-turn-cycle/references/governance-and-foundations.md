...
- **Verbatim §2 / §3 / §19 of the page plan** inlined from `docs/prose-renderer-contract/content-policy.md`, `docs/prose-renderer-contract/prose-craft-contract.md`, and `docs/prose-renderer-contract/render-time-instruction.md` respectively on every page. Operationally load-bearing — external LLM has no cross-plan state.
