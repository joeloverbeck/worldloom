...
6. **Phase 7 — Author the page plan.** Write `pages-prose-plans/PG-<integer>.md` per shared contract §8 — 19 sections, §2 / §3 / §19 inlined verbatim from `reports/prose-quality-instructions.md`. Load `references/phase-7-page-plan.md`.
