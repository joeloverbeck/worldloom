...
- **Runtime character authority is STCHAR.** Turn-cycle consumes active STCHAR via `STENT.bound_stchar_id`, `PG.state_snapshot.active_records.STCHAR`, targeted story-scoped retrieval, and CHC/STPLAN/STEMO/SREL grounding. It never reads world `CHAR-*` for runtime characterization.
