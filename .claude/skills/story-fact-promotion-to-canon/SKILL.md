...
7. Load world canon via `mcp__worldloom__get_context_packet(task_type='story_fact_promotion_to_canon', world_slug=<slug>, seed_nodes=[<source-relevant CFs+Ms+INVs+OQs>], token_budget=8000)`.
