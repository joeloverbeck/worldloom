...
- **Verbatim §2 / §3 / §19 of the page plan.** The page-plan-authoring phase inlines `reports/prose-quality-instructions.md` §Content Policy / §Prose Craft Contract / §Render-Time Instruction Template verbatim; see `references/phase-8-9-page-plan-and-choices.md` for the cold-context rationale. Compacting these sections would defeat the self-contained-plan contract.
